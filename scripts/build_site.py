...
REPOSITORY_URL: Final[str] = "https://github.com/kogunlowo123/ai-evals-regression-suite"
...
PAGES: Final[tuple[Page, ...]] = (
    ...
    Page(Path("docs/suites.md"), "suites", "Suite files", "Reference"),
    Page(Path("docs/graders.md"), "graders", "Graders", "Reference"),
    Page(Path("docs/gating.md"), "gating", "The gate", "Reference"),
    Page(Path("docs/mutation.md"), "mutation", "The meta-gate", "Reference"),
    Page(Path("docs/providers.md"), "providers", "Providers", "Reference"),
...
def build(output: Path) -> int:
    ...
    for page in PAGES:
        ...
        (output / page.output_name).write_text(
            TEMPLATE.format(
                title=html.escape("aievals" if page.slug == "index" else f"{page.title} — aievals"),
